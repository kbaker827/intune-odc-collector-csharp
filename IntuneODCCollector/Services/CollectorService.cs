...
public class CollectorService
{
    ...
    private readonly XmlDownloadService _xmlDownload;
    ...
    public CollectorService()
    {
        ...
        _xmlDownload = new XmlDownloadService(http);
        ...
        CancellationToken ct)
    {
        ...
        var xmlPath = await _xmlDownload.GetXmlAsync(LogDir, cacheXml, log, ct);
